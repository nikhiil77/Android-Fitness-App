...
public class MaleHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener((AdapterView<?> parent, View view, int position, long id) -> {
            ...
            Intent intent = new Intent(MaleHomeActivity.this, WorkoutActivity.class);
            intent.putExtra("workoutCategory", selectedWorkout.getName());
    ...
    private void setupSearch() {
        ...
        searchView.setQueryHint("Search workouts...");
    ...
    private void setupCalendar() {
        ...
        for (int i = 1; i <= daysInMonth; i++) {
            ...
            dayView.setOnClickListener(v -> {
                selectDay(v);
                Toast.makeText(MaleHomeActivity.this, "Selected: " + day, Toast.LENGTH_SHORT).show();
            });
    ...
    private List<Workout> getWorkoutCategories() {
        ...
        workouts.add(new Workout("Chest", R.drawable.chest_icon));
        workouts.add(new Workout("Biceps", R.drawable.biceps_icon));
        workouts.add(new Workout("Triceps", R.drawable.triceps_icon));
        workouts.add(new Workout("Shoulders", R.drawable.shoulders_icon));
        workouts.add(new Workout("Back", R.drawable.back_icon));
        workouts.add(new Workout("Abs", R.drawable.abs_icon));
        workouts.add(new Workout("Legs", R.drawable.legs_icon));
        return workouts;
    }
}